...
$about_tab_active = strpos($_SERVER['REQUEST_URI'],'about') > 0 ? 'class="active"' : ''; 

$download_tab_active = strpos($_SERVER['REQUEST_URI'],'download') > 0 ? 'class="active"' : ''; 

$events_tab_active = strpos($_SERVER['REQUEST_URI'],'events') > 0 ? 'class="active"' : ''; 

$client_tab_active = strpos($_SERVER['REQUEST_URI'],'our-clients') > 0 ? 'class="active"' : ''; 

$certificates_tab_active = strpos($_SERVER['REQUEST_URI'],'certificates') > 0 ? 'class="active"' : ''; 

$contact_tab_active = strpos($_SERVER['REQUEST_URI'],'contact-us') > 0 ? 'class="active"' : ''; 

$faq_tab_active = strpos($_SERVER['REQUEST_URI'],'faq') > 0 ? 'class="active"' : ''; 

$product_tab_active = strpos($_SERVER['REQUEST_URI'],'our-products') > 0 ? 'class="active"' : ''; 
