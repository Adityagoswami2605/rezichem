					...
					<div class="projects-header">
						...
						<div class="gallery-grids">
							...
							<div class="col-md-4 gallery-grid">								
								 <a class="fancybox" href="<?=SITEURL?>product-<?=$category_slug?>" data-fancybox-group="gallery" title="<?=$category_name?>"><img src="<?=CATEGORYURL.$category_image?>" class="img-style row6" alt=""><span> </span></a>							
								<h4><?=$category_name?></h4>						
							</div>
							<?php
}
